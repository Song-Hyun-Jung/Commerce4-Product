...
import com.digital4.service.ProductService;
...
public class ProductController {
	...
	public ResponseEntity<?> insertProduct(
		...
		try {
			if(productSvc.insertProduct(product, authHeader)){
	...
	@ApiResponses({ @ApiResponse(code = 200, message = "성공", response = Product.class),
			@ApiResponse(code = 500, message = "실패", response = ErrorMsg.class) })
	public ResponseEntity<?> findProductById(@ApiParam(value = "1", example="1") @PathVariable long productId) {
		MultiValueMap<String, String> header = new LinkedMultiValueMap<String, String>();
